...
import com.android.trail.map.Rate;
import com.android.trail.map.adapter.AlbumGridViewAdapter;
import com.android.trail.map.util.AlbumHelper;
import com.android.trail.map.util.Bimp;
import com.android.trail.map.util.ImageBucket;
 ...
 */
public class AlbumActivi extends Activity {
	//显示手机里的所有图片的列表控件
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				...
				intent.setClass(AlbumActivi.this, GalleryActivi.class);
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(mContext, scencyRate.class);
			startActivity(intent);
			finish();
		}
	...
	private class BackListener implements OnClickListener {
		public void onClick(View v) {
			intent.setClass(AlbumActivi.this, ImageFi.class);
			startActivity(intent);
		}
	}
					...
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num) {
							...
							if (!removeOneData(dataList.get(position))) {
								Toast.makeText(AlbumActivi.this, Res.getString("only_choose_num"),
										200).show();
							}
							return;
						}
