 ...
 */
public class Map_list_west extends Activity {
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(i>=0){
                    Intent intent=new Intent(Map_list_west.this,MapShow_list.class);
...
//        }
        for(int i=0;i<15;i++) {
            ls.add(new shop(String.valueOf(R.drawable.shop_list1), String.valueOf(0), "西门商业区", "￥115 免运费 北京"));
        }
    }
}
